...
@Component({
  selector: 'app-import-executive-summary',
  templateUrl: './import-executive-summary.component.html',
  styleUrls: ['./import-executive-summary.component.scss',
  '../../../../assets/scss/from-coomon.scss'

  ]
})
export class ImportExecutiveSummaryComponent implements OnInit {
  isLoading = false;
