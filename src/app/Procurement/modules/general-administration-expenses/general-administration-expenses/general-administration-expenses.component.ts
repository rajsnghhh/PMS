...
@Component({
  selector: 'app-general-administration-expenses',
  templateUrl: './general-administration-expenses.component.html',
  styleUrls: [
    './general-administration-expenses.component.scss',
    '../../../../../assets/scss/scrollableTable.scss',
    '../../../../../assets/scss/micro-view-table.scss',
    '../../../../../assets/scss/tableactionButton.scss'
  ],
})
export class GeneralAdministrationExpensesComponent {
  localStorageData: any;
  generalAdminExpensesList: any;
  itemList: any;
  siteList: any;
  ...
  onSearch() {
    ...
    this.procurementAPIService.getFabricationWork(params).subscribe((data) => {
      this.generalAdminExpensesList = data.results;

      // this.generalAdminExpensesList.forEach((_covenants: any) => {
  ...
  updateByID(id: any) {
    this.RouteToRoll('/pms/'+this.activeroute.snapshot.paramMap.get('procurementScope')+'/procurement/general-administration-expenses/edit/' + id)
  }
