...
@Component({
  selector: 'app-way-bill-advanced-search',
  templateUrl: './way-bill-advanced-search.component.html',
  styleUrls: ['./way-bill-advanced-search.component.scss',
  '../../../../../../assets/scss/scrollableTable.scss']
})
export class WayBillAdvancedSearchComponent {
  ...
  addNew() {
    this.router.navigate(['/pms/' + this.activeroute.snapshot.paramMap.get('procurementScope') + '/procurement/way-bill/add'])
  }  
  link_GRN_or_PurchaseBill() {
    this.router.navigate(['/pms/' + this.activeroute.snapshot.paramMap.get('procurementScope') + '/procurement/way-bill/linking'])
  }
