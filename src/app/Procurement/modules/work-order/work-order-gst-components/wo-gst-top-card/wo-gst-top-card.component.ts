...
@Component({
  selector: 'app-wo-gst-top-card',
  templateUrl: './wo-gst-top-card.component.html',
  styleUrls: ['./wo-gst-top-card.component.scss']
})
export class WoGstTopCardComponent {
  form: any = {}
  ...
  onSubmit() {
    this.form.wo_gst_top_Valid = true
