...
@Component({
  selector: 'app-purchase-order-check',
  templateUrl: './purchase-order-check.component.html',
  styleUrls: ['./purchase-order-check.component.scss',
  '../../../../../../assets/scss/micro-view-table.scss',
  '../../../../../../assets/scss/scrollableTable.scss',
  '../../../../../../assets/scss/tableactionButton.scss']
})
export class PurchaseOrderCheckComponent {
  ...
  checkSubmit(){
    ...
    for(let i=0;i<this.purchaseCheckboxIds.length;i++) {
      req.push({
        ...
        "status": "checked",
        "checked_remarks":this.purchaseOrderList.find((data:any)=>data.id==this.purchaseCheckboxIds[i]).checked_remarks
      })
    }
