...
@Component({
  selector: 'app-planning-head',
  templateUrl: './planning-head.component.html',
  styleUrls: ['./planning-head.component.scss',
  '../../../../assets/scss/from-coomon.scss',
]
})
export class PlanningHeadComponent implements OnInit,OnChanges {
  ...
  constructor(
    ...
    this.planningForm = formBuilder.group({
  ...
  ngOnChanges(): void {
    if(this.projectId?.is_planning_head_selected==true){
       this.planningData.planningHead=this.projectId.planning_head;
    }
  }
  ...
  addPlanning(){
    if (this.planningForm.valid) {
      ...
      this.apiservice.addPlanningHead(params).subscribe(data=>{
      ...
      this.markFormGroupTouched(this.planningForm);
    }
