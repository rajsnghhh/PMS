...
@Component({
  selector: 'app-add-planning-structure',
  templateUrl: './add-planning-structure.component.html',
  styleUrls: ['./add-planning-structure.component.scss',
  '../../../../../assets/scss/from-coomon.scss',
  '../../../../../assets/scss/scrollableTable.scss']
})
export class AddPlanningStructureComponent {
