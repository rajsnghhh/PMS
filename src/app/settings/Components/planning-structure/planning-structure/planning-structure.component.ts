...
import { EditPlanningStructureComponent } from '../edit-planning-structure/edit-planning-structure.component';
...
@Component({
  selector: 'app-planning-structure',
  templateUrl: './planning-structure.component.html',
  styleUrls: [
    './planning-structure.component.scss',
    '../../../../../assets/scss/scrollableTable.scss'
  ]
})

export class PlanningStructureComponent implements OnInit {

  @ViewChild('editCompany')
  editCompany!: EditPlanningStructureComponent;
