...
@Component({
  selector: 'app-add-material-types',
  templateUrl: './add-material-types.component.html',
  styleUrls: ['./add-material-types.component.scss',
...
export class AddMaterialTypesComponent {
  ...
  addWBS(){
    ...
    this.apiservice.addMaterialTypeData(request).subscribe(data => {
      this.toastrService.success('Material Group Added Successfully', '', {
        timeOut: 2000,
      });
      setTimeout(function(){
