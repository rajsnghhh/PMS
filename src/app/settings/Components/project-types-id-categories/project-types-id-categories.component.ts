...
@Component({
  selector: 'app-project-types-id-categories',
  templateUrl: './project-types-id-categories.component.html',
  styleUrls: ['./project-types-id-categories.component.scss',
    '../../../../assets/scss/scrollableTable.scss']
})
export class ProjectTypesIdCategoriesComponent {
